...
function ChatContainer(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { id: run_id, className: 'flex flex-col h-[85vh] mt-10', children: [(0, jsx_runtime_1.jsxs)("div", { className: 'absolute w-full', children: [(0, jsx_runtime_1.jsxs)("div", { className: 'relative', ref: tooldropdownRef, children: [(0, jsx_runtime_1.jsx)("button", { onClick: () => {
                                            setIsToolDropdownOpen(!isToolDropdownOpen);
                                            setIsDropdownOpen(false);
                                        }, className: 'absolute top-[-32px] right-12 p-1 rounded-full hover:transform hover:scale-105 transition-all', children: (0, jsx_runtime_1.jsx)("div", { className: "w-6 h-6 overflow-hidden", children: (0, jsx_runtime_1.jsx)(lucide_react_1.LayoutGrid, { className: "w-full h-full" }) }) }), isToolDropdownOpen && ((0, jsx_runtime_1.jsx)("div", { className: 'absolute right-12 top-2 z-[500] w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none', children: (0, jsx_runtime_1.jsxs)("div", { className: 'py-1', children: [(0, jsx_runtime_1.jsxs)("button", { onClick: () => setPage('code-convertor'), className: 'flex items-center w-full px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700', children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Code, { className: "mr-2 h-4 w-4" }), "Code Convertor"] }), (0, jsx_runtime_1.jsxs)("button", { onClick: () => setPage('flowchart'), className: 'flex items-center w-full px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700', children: [(0, jsx_runtime_1.jsx)(fc_1.FcFlowChart, { className: "mr-2 h-4 w-4" }), "Flowcharts"] })] }) }))] }), (0, jsx_runtime_1.jsxs)("div", { className: 'relative', ref: dropdownRef, children: [(0, jsx_runtime_1.jsx)("button", { onClick: () => {
                                            setIsDropdownOpen(!isDropdownOpen);
                                            setIsToolDropdownOpen(false);
                                        }, className: 'absolute top-[-35px] right-0 p-1 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors', children: (0, jsx_runtime_1.jsx)("div", { className: "w-8 h-8 overflow-hidden rounded-full bg-gray-200", children: (0, jsx_runtime_1.jsx)("img", { src: user?.picture, alt: "user", className: 'w-full h-full object-cover' }) }) }), isDropdownOpen && ((0, jsx_runtime_1.jsx)("div", { className: 'absolute right-0 top-2 z-[500] w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none', children: (0, jsx_runtime_1.jsxs)("div", { className: 'py-1', children: [(0, jsx_runtime_1.jsxs)("button", { onClick: handleLogout, className: 'flex items-center w-full px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700', children: [(0, jsx_runtime_1.jsx)(lucide_react_1.LogOut, { className: "mr-2 h-4 w-4" }), "Logout"] }), (0, jsx_runtime_1.jsxs)("button", { onClick: handleNewChat, className: 'flex items-center w-full px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700', children: [(0, jsx_runtime_1.jsx)(lucide_react_1.PlusCircle, { className: "mr-2 h-4 w-4" }), "New Chat"] }), (0, jsx_runtime_1.jsxs)("button", { onClick: handleChatHistory, className: 'flex items-center w-full px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700', children: [(0, jsx_runtime_1.jsx)(lucide_react_1.History, { className: "mr-2 h-4 w-4" }), "Chat History"] })] }) }))] })] }), (0, jsx_runtime_1.jsx)("div", { className: 'flex-1 overflow-y-auto pr-4 my-5', style: {
                            scrollbarWidth: "thin",
