(self["webpackChunkanalyz"] = self["webpackChunkanalyz"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_mindmap-definition-OEB2RXX2_mjs"],{
...
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! khroma */ "./node_modules/mermaid/node_modules/khroma/dist/methods/is_dark.js");
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! khroma */ "./node_modules/mermaid/node_modules/khroma/dist/methods/lighten.js");
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! khroma */ "./node_modules/mermaid/node_modules/khroma/dist/methods/darken.js");
...
var getParent = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function(level) {
...
var getMindmap = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(() => {
  return nodes.length > 0 ? nodes[0] : null;
}, "getMindmap");
var addNode = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((level, id, descr, type) => {
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.info("addNode", level, id, descr, type);
  const conf = (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig2)();
  let padding = conf.mindmap?.padding ?? _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.defaultConfig_default.mindmap.padding;
  switch (type) {
  ...
  const node = {
    id: cnt++,
    nodeId: (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.sanitizeText)(id, conf),
    level,
    descr: (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.sanitizeText)(descr, conf),
    type,
    children: [],
    width: conf.mindmap?.maxNodeWidth ?? _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.defaultConfig_default.mindmap.maxNodeWidth,
    padding
  };
...
var getType = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((startStr, endStr) => {
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug("In get type", startStr, endStr);
  switch (startStr) {
    case "[":
...
var setElementForId = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((id, element) => {
  elements[id] = element;
}, "setElementForId");
var decorateNode = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((decoration) => {
  if (!decoration) {
    return;
  }
  ...
  if (decoration.icon) {
    node.icon = (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.sanitizeText)(decoration.icon, config);
  }
  if (decoration.class) {
    node.class = (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.sanitizeText)(decoration.class, config);
  }
}, "decorateNode");
var type2Str = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((type) => {
  switch (type) {
...
var getLogger = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(() => _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log, "getLogger");
var getElementById = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((id) => elements[id], "getElementById");
var db = {
  clear,
  addNode,
  getMindmap,
...
var MAX_SECTIONS = 12;
var defaultBkg = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function(db2, elem, node, section) {
  const rd = 5;
...
var rectBkg = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function(db2, elem, node) {
...
var cloudBkg = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function(db2, elem, node) {
  const w = node.width;
  const h = node.height;
  const r1 = 0.15 * w;
  const r2 = 0.25 * w;
...
var bangBkg = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function(db2, elem, node) {
  const w = node.width;
  const h = node.height;
  const r = 0.15 * w;
  elem.append("path").attr("id", "node-" + node.id).attr("class", "node-bkg node-" + db2.type2Str(node.type)).attr(
...
var circleBkg = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function(db2, elem, node) {
...
var hexagonBkg = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function(_db, elem, node) {
  const h = node.height;
  const f = 4;
  const m = h / f;
...
var roundedRectBkg = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function(db2, elem, node) {
...
var drawNode = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(async function(db2, elem, node, fullSection, conf) {
  ...
  await (0,_chunk_U7L4IQIU_mjs__WEBPACK_IMPORTED_MODULE_0__.createText)(
    textElem,
    description,
    {
  ...
  const [fontSize] = (0,_chunk_TLUHKHBO_mjs__WEBPACK_IMPORTED_MODULE_1__.parseFontSize)(conf.fontSize);
...
var positionNode = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function(db2, node) {
...
(0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(drawNodes, "drawNodes");
function drawEdges(edgesEl, cy) {
  cy.edges().map((edge, id) => {
    const data = edge.data();
    if (edge[0]._private.bodyBounds) {
      const bounds = edge[0]._private.rscratch;
      _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.trace("Edge: ", id, data);
...
(0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(drawEdges, "drawEdges");
...
(0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(addNodes, "addNodes");
function layoutMindmap(node, conf) {
  return new Promise((resolve) => {
    ...
    cy.ready((e) => {
      _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.info("Ready", e);
      resolve(cy);
    });
  });
}
(0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(layoutMindmap, "layoutMindmap");
function positionNodes(db2, cy) {
  cy.nodes().map((node, id) => {
    ...
    _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.info("Id:", id, "Position: (", node.position().x, ", ", node.position().y, ")", data);
    el.attr(
      "transform",
...
(0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(positionNodes, "positionNodes");
var draw = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(async (text, id, _version, diagObj) => {
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug("Rendering mindmap diagram\n" + text);
  ...
  (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.setupGraphViewbox)(
    void 0,
    svg,
    conf.mindmap?.padding ?? _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.defaultConfig_default.mindmap.padding,
    conf.mindmap?.useMaxWidth ?? _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.defaultConfig_default.mindmap.useMaxWidth
  );
}, "draw");
...
var genSections = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((options) => {
  let sections = "";
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_mindmap-definition-OEB2RXX2_mjs.webview.js.map