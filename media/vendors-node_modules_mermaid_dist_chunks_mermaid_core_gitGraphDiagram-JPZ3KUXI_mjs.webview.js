"use strict";
(self["webpackChunkanalyz"] = self["webpackChunkanalyz"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_gitGraphDiagram-JPZ3KUXI_mjs"],{
...
(0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_0__.__name)(populateCommonDb, "populateCommonDb");
...
/* harmony export */ });
/* harmony import */ var _chunk_RYO7GUH3_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-RYO7GUH3.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-RYO7GUH3.mjs");
...
var DEFAULT_GITGRAPH_CONFIG = _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.defaultConfig_default.gitGraph;
var getConfig3 = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(() => {
  const config = (0,_chunk_TLUHKHBO_mjs__WEBPACK_IMPORTED_MODULE_2__.cleanAndMerge)({
    ...DEFAULT_GITGRAPH_CONFIG,
    ...(0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig)().gitGraph
  });
  return config;
}, "getConfig");
...
function getID() {
  return (0,_chunk_TLUHKHBO_mjs__WEBPACK_IMPORTED_MODULE_2__.random)({ length: 7 });
}
(0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(getID, "getID");
...
(0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(uniqBy, "uniqBy");
var setDirection = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function(dir2) {
  state.records.direction = dir2;
}, "setDirection");
var setOptions = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function(rawOptString) {
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug("options str", rawOptString);
  rawOptString = rawOptString?.trim();
  rawOptString = rawOptString || "{}";
  try {
    state.records.options = JSON.parse(rawOptString);
  } catch (e) {
    _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.error("error while parsing gitGraph options", e.message);
  }
}, "setOptions");
var getOptions = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function() {
  return state.records.options;
}, "getOptions");
var commit = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function(commitDB) {
  let msg = commitDB.msg;
  let id = commitDB.id;
  const type = commitDB.type;
  let tags = commitDB.tags;
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.info("commit", msg, id, type, tags);
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug("Entering commit:", msg, id, type, tags);
  const config = getConfig3();
  id = _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(id, config);
  msg = _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(msg, config);
  tags = tags?.map((tag) => _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(tag, config));
  const newCommit = {
  ...
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.info("main branch", config.mainBranchName);
  state.records.commits.set(newCommit.id, newCommit);
  state.records.branches.set(state.records.currBranch, newCommit.id);
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug("in pushCommit " + newCommit.id);
}, "commit");
var branch = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function(branchDB) {
  let name = branchDB.name;
  const order = branchDB.order;
  name = _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(name, getConfig3());
  ...
  checkout(name);
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug("in createBranch");
}, "branch");
var merge = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((mergeDB) => {
  let otherBranch = mergeDB.branch;
  let customId = mergeDB.id;
  const overrideType = mergeDB.type;
  const customTags = mergeDB.tags;
  const config = getConfig3();
  otherBranch = _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(otherBranch, config);
  if (customId) {
    customId = _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(customId, config);
  }
  ...
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug(state.records.branches);
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug("in mergeBranch");
}, "merge");
var cherryPick = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function(cherryPickDB) {
  let sourceId = cherryPickDB.id;
  let targetId = cherryPickDB.targetId;
  let tags = cherryPickDB.tags;
  let parentCommitId = cherryPickDB.parent;
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug("Entering cherryPick:", sourceId, targetId, tags);
  const config = getConfig3();
  sourceId = _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(sourceId, config);
  targetId = _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(targetId, config);
  tags = tags?.map((tag) => _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(tag, config));
  parentCommitId = _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(parentCommitId, config);
  ...
  if (!targetId || !state.records.commits.has(targetId)) {
    ...
    state.records.branches.set(state.records.currBranch, commit2.id);
    _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug(state.records.branches);
    _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug("in cherryPick");
  }
}, "cherryPick");
var checkout = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function(branch2) {
  branch2 = _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(branch2, getConfig3());
...
(0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(upsert, "upsert");
function prettyPrintCommitHistory(commitArr) {
  ...
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug(label.join(" "));
...
(0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(prettyPrintCommitHistory, "prettyPrintCommitHistory");
var prettyPrint = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function() {
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug(state.records.commits);
...
var getBranchesAsObjArray = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function() {
...
var getBranches = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function() {
  return state.records.branches;
}, "getBranches");
var getCommits = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function() {
  return state.records.commits;
}, "getCommits");
var getCommitsArray = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function() {
  const commitArr = [...state.records.commits.values()];
  commitArr.forEach(function(o) {
    _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug(o.id);
  });
  commitArr.sort((a, b) => a.seq - b.seq);
  return commitArr;
}, "getCommitsArray");
var getCurrentBranch = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function() {
  return state.records.currBranch;
}, "getCurrentBranch");
var getDirection = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function() {
  return state.records.direction;
}, "getDirection");
var getHead = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function() {
...
// src/diagrams/git/gitGraphParser.ts
var populate = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((ast, db2) => {
  (0,_chunk_RYO7GUH3_mjs__WEBPACK_IMPORTED_MODULE_0__.populateCommonDb)(ast, db2);
  if (ast.dir) {
...
var parseStatement = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((statement, db2) => {
  const parsers = {
    Commit: /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((stmt) => db2.commit(parseCommit(stmt)), "Commit"),
    Branch: /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((stmt) => db2.branch(parseBranch(stmt)), "Branch"),
    Merge: /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((stmt) => db2.merge(parseMerge(stmt)), "Merge"),
    Checkout: /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((stmt) => db2.checkout(parseCheckout(stmt)), "Checkout"),
    CherryPicking: /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((stmt) => db2.cherryPick(parseCherryPicking(stmt)), "CherryPicking")
  };
  const parser2 = parsers[statement.$type];
  if (parser2) {
    parser2(statement);
  } else {
    _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.error(`Unknown statement type: ${statement.$type}`);
  }
}, "parseStatement");
var parseCommit = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((commit2) => {
  const commitDB = {
    id: commit2.id,
    msg: commit2.message ?? "",
...
var parseBranch = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((branch2) => {
  const branchDB = {
    name: branch2.name,
...
var parseMerge = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((merge2) => {
  const mergeDB = {
...
var parseCheckout = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((checkout2) => {
  const branch2 = checkout2.branch;
  return branch2;
}, "parseCheckout");
var parseCherryPicking = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((cherryPicking) => {
  const cherryPickDB = {
    id: cherryPicking.id,
    targetId: "",
...
var parser = {
  parse: /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(async (input) => {
    const ast = await (0,_mermaid_js_parser__WEBPACK_IMPORTED_MODULE_4__.parse)("gitGraph", input);
    _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug(ast);
    populate(ast, db);
  }, "parse")
};
if (void 0) {
...
var DEFAULT_CONFIG = (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig2)();
...
var maxPos = 0;
var dir = "LR";
var clear3 = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(() => {
  branchPos.clear();
  commitPos.clear();
...
var drawText = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((txt) => {
...
var findClosestParent = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((parents) => {
  let closestParent;
  let comparisonFunc;
  let targetPosition;
  if (dir === "BT") {
    comparisonFunc = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((a, b) => a <= b, "comparisonFunc");
...
var findClosestParentBT = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((parents) => {
  let closestParent = "";
...
var setParallelBTPos = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((sortedKeys, commits, defaultPos2) => {
...
var findClosestParentPos = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((commit2) => {
...
var calculateCommitPosition = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((commit2) => {
  const closestParentPos = findClosestParentPos(commit2);
  return closestParentPos + COMMIT_STEP;
}, "calculateCommitPosition");
var setCommitPosition = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((commit2, curPos) => {
...
var setRootPosition = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((commit2, curPos, defaultPos2) => {
  const branch2 = branchPos.get(commit2.branch);
  if (!branch2) {
    throw new Error(`Branch not found for commit ${commit2.id}`);
  }
...
var drawCommitBullet = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((gBullets, commit2, commitPosition, typeClass, branchIndex, commitSymbolType) => {
...
var drawCommitLabel = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((gLabels, commit2, commitPosition, pos) => {
...
var drawCommitTags = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((gLabels, commit2, commitPosition, pos) => {
...
var getCommitClassType = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((commit2) => {
...
var calculatePosition = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((commit2, dir2, pos, commitPos2) => {
...
var getCommitPosition = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((commit2, pos, isParallelCommits) => {
...
var drawCommits = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((svg, commits, modifyGraph) => {
  ...
  const sortKeys = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((a, b) => {
...
var shouldRerouteArrow = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((commitA, commitB, p1, p2, allCommits) => {
  const commitBIsFurthest = dir === "TB" || dir === "BT" ? p1.x < p2.x : p1.y < p2.y;
  const branchToGetCurve = commitBIsFurthest ? commitB.branch : commitA.branch;
  const isOnBranchToGetCurve = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((x) => x.branch === branchToGetCurve, "isOnBranchToGetCurve");
  const isBetweenCommits = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((x) => x.seq > commitA.seq && x.seq < commitB.seq, "isBetweenCommits");
  return [...allCommits.values()].some((commitX) => {
    return isBetweenCommits(commitX) && isOnBranchToGetCurve(commitX);
  });
}, "shouldRerouteArrow");
var findLane = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((y1, y2, depth = 0) => {
...
var drawArrow = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((svg, commitA, commitB, allCommits) => {
...
var drawArrows = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((svg, commits) => {
...
var drawBranches = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((svg, branches) => {
...
var setBranchPosition = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function(name, pos, index, bbox, rotateCommitLabel) {
  branchPos.set(name, { pos, index });
  pos += 50 + (rotateCommitLabel ? 40 : 0) + (dir === "TB" || dir === "BT" ? bbox.width / 2 : 0);
  return pos;
}, "setBranchPosition");
var draw = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(function(txt, id, ver, diagObj) {
  clear3();
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug("in gitgraph renderer", txt + "\n", "id:", id, ver);
  if (!DEFAULT_GITGRAPH_CONFIG2) {
    throw new Error("GitGraph config not found");
  }
  ...
  (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.setupGraphViewbox2)(
    void 0,
    diagram2,
...
if (void 0) {
  ...
  describe("branchPosition", () => {
    const bbox = {
      ...
      bottom: 0,
      left: 0,
      toJSON: /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(() => "", "toJSON")
    };
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_gitGraphDiagram-JPZ3KUXI_mjs.webview.js.map