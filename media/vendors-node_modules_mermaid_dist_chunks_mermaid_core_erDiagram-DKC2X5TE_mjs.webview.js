"use strict";
(self["webpackChunkanalyz"] = self["webpackChunkanalyz"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_erDiagram-DKC2X5TE_mjs"],{
...
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! uuid */ "./node_modules/mermaid/node_modules/uuid/dist/esm-browser/v5.js");
...
var addEntity = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.__name)(function(name, alias = void 0) {
  if (!entities.has(name)) {
    entities.set(name, { attributes: [], alias });
    _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.log.info("Added new entity :", name);
  } else if (!entities.get(name).alias && alias) {
    entities.get(name).alias = alias;
    _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.log.info(`Add alias '${alias}' to entity '${name}'`);
  }
  return entities.get(name);
}, "addEntity");
var getEntities = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.__name)(() => entities, "getEntities");
var addAttributes = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.__name)(function(entityName, attribs) {
  let entity = addEntity(entityName);
  let i;
  for (i = attribs.length - 1; i >= 0; i--) {
    entity.attributes.push(attribs[i]);
    _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.log.debug("Added attribute ", attribs[i].attributeName);
  }
}, "addAttributes");
var addRelationship = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.__name)(function(entA, rolA, entB, rSpec) {
  let rel = {
    entityA: entA,
    roleA: rolA,
    entityB: entB,
  ...
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.log.debug("Added new relationship :", rel);
}, "addRelationship");
var getRelationships = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.__name)(() => relationships, "getRelationships");
...
var erDb_default = {
  Cardinality,
  Identification,
  getConfig: /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.__name)(() => (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.getConfig2)().er, "getConfig"),
  addEntity,
  addAttributes,
  getEntities,
  addRelationship,
...
var insertMarkers = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.__name)(function(elem, conf2) {
  let marker;
...
var drawAttributes = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.__name)((groupNode, entityTextNode, attributes) => {
  ...
  attributes.forEach((item) => {
    ...
    let nodeHeight = 0;
    const attributeType = (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.parseGenericTypes)(item.attributeType);
    const typeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-type`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.getConfig2)().fontFamily).style("font-size", attrFontSize + "px").text(attributeType);
...
var drawEntities = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.__name)(function(svgNode, entities2, graph) {
...
var adjustEntities = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.__name)(function(svgNode, graph) {
...
var getEdgeName = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.__name)(function(rel) {
  return (rel.entityA + rel.roleA + rel.entityB).replace(/\s/g, "");
}, "getEdgeName");
var addRelationships = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.__name)(function(relationships2, g) {
...
var relCnt = 0;
var drawRelationshipFromLayout = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.__name)(function(svg, rel, g, insert, diagObj) {
  relCnt++;
  const edge = g.edge(
...
var draw = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.__name)(function(text, id, _version, diagObj) {
  conf = (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.getConfig2)().er;
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.log.info("Drawing ER diagram");
  ...
  _chunk_TLUHKHBO_mjs__WEBPACK_IMPORTED_MODULE_0__.utils_default.insertTitle(svg, "entityTitleText", conf.titleTopMargin, diagObj.db.getDiagramTitle());
  const svgBounds = svg.node().getBBox();
  const width = svgBounds.width + padding * 2;
  const height = svgBounds.height + padding * 2;
  (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.configureSvgSize)(svg, height, width, conf.useMaxWidth);
...
(0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.__name)(generateId, "generateId");
function strWithHyphen(str = "") {
  return str.length > 0 ? `${str}-` : "";
}
(0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__.__name)(strWithHyphen, "strWithHyphen");
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_erDiagram-DKC2X5TE_mjs.webview.js.map