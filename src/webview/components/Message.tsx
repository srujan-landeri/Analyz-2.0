...
export default function Message(props: any) {
    ...
    return (
        <div className="flex flex-col w-full animate-fade-in">
            ...
            <div className={`font-normal rounded-md text-black dark:text-white`}>
                <ReactMarkdown
                    children={message}
                        ...
                        code(props) {
                            ...
                            if (!match) {
                                ...
                                return (
                                    <code
                                        {...rest}
                                        className="bg-zinc-800 text-orange-400 px-1.5 py-0.5 font-mono text-xs"
                                    >
                                        {children}
                                    </code>
                                );
            ...
            <p className='text-[0.7rem] mt-2 text-gray-500 dark:text-gray-400 text-right'>
                Generated By: <span className="font-semibold text-[0.8rem] text-white">{model}</span>
            </p> :
            <p className='text-[0.7rem] mt-2 text-gray-500 dark:text-gray-400 text-right'>
                 &nbsp;
            </p>
