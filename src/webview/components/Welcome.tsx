...
export default function WelcomeScreen() {
  const features = [
    { icon: <Search className="w-5 h-5" />, text: "Search Websites" },
    { icon: <Globe className="w-5 h-5" />, text: "Search The Web" },
    { icon: <FileText className="w-5 h-5" />, text: "Search Research Papers" },
    { icon: <Image className="w-5 h-5" />, text: "Interpret Images" },
    ...
    <div className="flex flex-col items-center justify-center min-h-[400px] p-8 space-y-6">
      ...
      <div className="mt-8">
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Type your question or request to get started
        </p>
      </div>
    </div>
  );
